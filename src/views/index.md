...
This might be an inevitability of 
...
The Arts is a very subjective. But there are lots of opportunities to explore transcultural arts through the process of design. It could be because of commissioned work, or some chance encounter with another person or place that inspires you to want to know and understand more about a certain language and culture. But once you have a desire for such knowledge, you are well-prepared to be open to foreign ideas and concepts.  
“This looks ugly. That looks beautiful!” Why would you think that? What do other people think? Such awareness requires a long period of constantly seeking to understand different cultural motivations and individual opinions, before it is possible to capture the essence of a foreign country's visual culture. Not asking any questions at all is a true sign of ignorance.
...
Take the example of “Chinese-style” Arabic characters (Chinese-style Arabic calligraphy )
...
Roman：我想在这里补充说明一点：以技术为基础的中文字体开发也不完全是西方在做的事，否则只能得出创造性科技是西方理念、艺术造诣则属于中国人这样的定义。我认为中国设计师也是在数字环境中运用科技来处理完成工作。也不能认为数字环境就比实体世界的美学理想低一等，这只会导向另一种不同的审美观念，<span class="checkagainst">而西方并不崇尚和鼓励这种观念</span>。  
I'd like to add on that it's not entirely accurate to say that Western designers are driven by the technology of their time while Chinese designers operate from purely aesthetic and artistic motivations. I feel that Chinese designers in today's digital age have also adopted technology to help with their production process. We cannot assume that the aesthetic quality of the digital types is inferior to that of physical types. They are merely different.
...
Our classification styles of Song, Hei, Fang and Kai are very different from that of the West, e.g. Neo-Grotesk and Humanist Sans. Chinese character styles not only have a different morphology, but they are also deeply influenced by the history and culture during the time in which they were developed. Conversely, the calligraphic nature of Latin scripts were decoupled from printing the moment punch-cutting became a profession. Neo-Grotesk and Humanist Sans have the same core structure, in spite of their difference in profile. With such historical precedence, we should be cautious about abandoning calligraphic principles as this is akin to throwing away thousands of years of Chinese culture and history. And it also 
...
What impact has foreign influence over history had on the design of Chinese typefaces? How can we find a balance between , experimental and ?
...
Mira：「在书写经验之内的陌生感」，这个描述让我想起罗小弟设计的「老外宋」，而它又让人想起传教士铸刻的形态略怪异的铅活字。大多数人认为后者不是美学典范，但前者却得到不少现代设计师的青睐。小弟你认为对异国文字的实验（或者说想像）与怪异之间的界限在哪里？
...
Chuyang：这里还有个投入的问题。一方面，如果一个字体厂商已经有五十个熟练工，三个月就能生产一套字库，厂商宁愿用现有的方法造字，这在商业上是成功的，而很少会愿意花额外精力去研究这套新系统。另一方面，技术能解决的事情很少，即使软件先把笔画全都帮你放到位，也没有节省多少时间。我计算过，把设计好的笔画自动复制粘贴、放置到字形里，一共就省四天时间。哪怕能省一个月，也没有什么意思嘛。
...
Peiran：汉字在一、二战期间，尤其是在上海，也经涌现过许多新艺术风格、装饰艺术风格的设计。联系上海的地理和经济重心，以及中国的殖民文化输入历史，可以说这些美术字的理念与西方的「几何化、特征极端化」几无区别。而在八九十年代，中国也曾出现过像 Emigre 那样的解构主义排版。也就是说，这不是「有无平行可能」，而是「历史上已经有过」。
